...
class EUCareersScraper(BaseScraper):
    """Scraper for EU Careers / EPSO job opportunities."""
    ...
    async def fetch_listings(self) -> list[dict]:
        ...
        async with httpx.AsyncClient(timeout=30, follow_redirects=True) as client:
            ...
            # EU Careers uses various listing formats
            selectors = [
            ...
            for selector in selectors:
                for link in soup.select(selector):
                    ...
                    if not href.startswith("http"):
                        href = f"https://eu-careers.europa.eu{href}"
                    ...
                    try:
                        ...
                        body = detail.select_one(
                            "main, .field--name-body, article, .content"
                        )
                        desc = (
