...
class FrontexScraper(BaseScraper):
    """Scraper for Frontex career vacancies."""
            ...
            for selector in selectors:
                for link in soup.select(selector):
                    ...
                    if not href.startswith("http"):
                        href = f"https://www.frontex.europa.eu{href}"
                    ...
                    listings.append(
                        {
                            ...
                            "location": self._find_location(desc) or "Warsaw",
                        }
                    )
