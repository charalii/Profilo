...
export const metadata: Metadata = {
  ...
  keywords: [
    "EU jobs","EPSO competition","EPSO jobs","EPSO 2025","EPSO 2026",
    "NATO careers","NATO civilian jobs","NATO Brussels",
    "UN careers","UN jobs","United Nations jobs","UN P3 P4 P5",
    "OECD careers","OECD jobs Paris","OSCE jobs Vienna",
    "international organisation careers","EU institutions jobs",
    "European Commission jobs","European Parliament jobs","Brussels jobs",
    "international civil servant","CAST permanent","AD grade EU","EU vacancy",
    "EU career","international job matching","EU CV matching",
    "cover letter EU institutions","EPSO application tips","EU career coach",
    "EU job alerts","institutional language CV","compliance scoring EU jobs",
  ],
